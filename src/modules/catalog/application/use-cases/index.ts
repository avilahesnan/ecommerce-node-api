...
export const addCategoryProductUseCase = new AddCategoryProductUseCase(productRepository, categoryRepository);
export const removeCategoryProductUseCase = new RemoveCategoryProductUseCase(productRepository, categoryRepository);
